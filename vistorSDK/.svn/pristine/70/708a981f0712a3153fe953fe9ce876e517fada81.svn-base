...
#define WRITEQUEUE_CAPACITY 5*30          // Initial capacity
#define READALL_CHUNKSIZE	128         // Incremental increase in buffer size
#define WRITE_CHUNKSIZE    1024//(1024 * 20)   // Limit on size of each write pass
